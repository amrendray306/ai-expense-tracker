...
exports.getGroupAnalytics = exports.getGroupBalances = exports.addMember = exports.getGroupById = exports.getGroups = exports.createGroup = void 0;
...
const addMember = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const id = req.params.id; // groupId
...
const getGroupBalances = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        // Fetch all shared expenses and settlements for the group
        const expenses = yield prisma.sharedExpense.findMany({
            where: { groupId: id },
            include: { splits: true }
        });
        const settlements = yield prisma.settlement.findMany({
            where: { groupId: id }
        });
...
const getGroupAnalytics = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        const [expenses, group] = yield Promise.all([
...
exports.getGroupAnalytics = getGroupAnalytics;
